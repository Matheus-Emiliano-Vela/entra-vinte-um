...
// Simula um banco de dados de missões: [ID, Nome, Objetivo, DataLançamento, 
    ...
    naves: [ID, Nome, Tipo, Capacidade] private static List<String[]> naves = new
            ArrayList<>();
    // Simula um banco de dados de astronautas: [ID, Nome, Especialidade] private static
...
System.out.println("Opção inválida. Tente novamente.");
    public static void adicionarMissao(String nome, String objetivo, String dataLancamento, String
            status) {
        missoes.add(new String[]{String.valueOf(proximoIdMissao++), nome, objetivo,
                dataLancamento, status, "N/A", "N/A"}); // ID Nave, ID Astronautas System.out.println("Missão " +
